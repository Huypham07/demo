...
\textbf{RQ1 --- Hiệu quả của phương pháp neuro-symbolic trong phân loại câu ESG.} Tích hợp ràng buộc tri thức ký hiệu vào mô hình PhoBERT thông qua hàm mất mát ngữ nghĩa cải thiện Macro F1 từ 0,758 lên 0,832 cho phân loại chủ đề và từ 0,767 lên 0,821 cho phân loại hành động. Cải thiện lớn nhất đạt được ở các lớp khó và mất cân bằng: lớp Planning tăng F1 từ 0,63 lên 0,70, lớp E (Môi trường) tăng từ 0,73 lên 0,79. Chất lượng phân loại này là nền tảng cho các bước liên kết bằng chứng, tính EWRI sau này.

\textbf{RQ2 --- Hiệu quả của liên kết bằng chứng ngữ nghĩa.} Phương pháp liên kết bằng chứng hai giai đoạn gồm truy xuất ngữ nghĩa và xác minh NLI vượt trội so với các phương pháp cơ sở về chất lượng liên kết. Phương pháp NLI phủ 97,3\% câu ESG, vượt trội so với Window chỉ đạt 66,3\% do bị giới hạn phạm vi lân cận. Truy xuất ngữ nghĩa đạt cosine similarity cao hơn cửa sổ ngữ cảnh 12,9\% (0,746 so với 0,661). Bước xác minh NLI phát hiện 2,7\% cặp mâu thuẫn và phân biệt được giữa bằng chứng hỗ trợ (entailment, 33,8\%) và bằng chứng trung lập (63,5\%) --- khả năng mà phương pháp chỉ dựa trên cosine similarity không làm được. Kết quả cho thấy 66,2\% tuyên bố ESG trong báo cáo thường niên thiếu bằng chứng xác nhận (không đạt entailment).

\textbf{RQ3 --- Khả năng phân tích của EWRI.} Chỉ số EWRI phân biệt có ý nghĩa giữa 10 ngân hàng, với khoảng cách 9,66 điểm giữa ngân hàng minh bạch nhất (33,83) và kém minh bạch nhất (43,49). Phân rã EWRI cho thấy thành phần Indeterminate đóng góp 98,0\% tổng rủi ro, xác nhận ngôn ngữ mơ hồ là nguồn ESG-washing chính. Về phân tích chủ đề, Quản trị (G) có EWRI cao nhất (39,17) với tỉ lệ Indeterminate 69,8\%, trong khi Môi trường (E) có EWRI thấp nhất (32,70). Phân tích tương quan xác nhận tỉ lệ Indeterminate và Implemented là hai yếu tố quyết định chính của EWRI ($r = 0{,}99$ và $r = -0{,}97$, $p < 0{,}001$).

\textbf{RQ3 --- Khả năng phân tích của EWRI.} Chỉ số EWRI có ý nghĩa giữa 10 ngân hàng, với khoảng cách 2,85 điểm giữa ngân hàng minh bạch nhất (NH\_A, 30,79) và kém minh bạch nhất (NH\_C, 33,64). Phân rã EWRI cho thấy thành phần Indeterminate đóng góp 82,3\% tổng rủi ro và Implemented đóng góp 16,1\%, xác nhận mức độ cam kết hành động là yếu tố quyết định chính. Về phân tích chủ đề, Quản trị (G) có EWRI cao nhất (32,26) với tỉ lệ Indeterminate 68,4\%, trong khi Môi trường (E) có EWRI thấp nhất (29,74) nhờ tỉ lệ Implemented và Planning cao hơn. Phân tích tương quan Spearman xác nhận tỉ lệ Indeterminate và Implemented là hai yếu tố quyết định chính của EWRI ($\rho = 0{,}888$ và $\rho = -0{,}852$, $p < 0{,}001$).
