...
Nghiên cứu so sánh ba phương pháp liên kết bằng chứng trên toàn bộ 32.260 câu ESG (sau khi lọc qua bước phân loại hành động):
...
Chủ đề G (Quản trị) chiếm tỉ trọng lớn nhất (52,0\%) và có EWRI cao nhất ($\approx 39$), phản ánh xu hướng các ngân hàng dành nhiều nội dung cho quản trị doanh nghiệp nhưng chủ yếu ở mức mơ hồ (68,4\% Indeterminate).
...
Để minh họa khả năng giải thích của hệ thống, phần này phân tích một số trường hợp cụ thể cho thấy pipeline hoạt động đúng ở cả hai cực rủi ro. Trường hợp rủi ro cao điển hình là câu \textit{``Nghiên cứu, triển khai áp dụng các tiêu chuẩn môi trường - xã hội - quản trị trong doanh nghiệp (ESG).''} (NH\_A, 2021, G/Indeterminate, WRS = 0,550): ngôn ngữ mơ hồ không có cam kết cụ thể, không có KPI hay mốc thời gian, NLI không xác nhận entailment (support = 0). Ngược lại, câu \textit{``Tỷ trọng tín dụng xanh tại Ngân hàng [NH\_F] hiện đã lên tới hơn 10\% trên tổng danh mục cho vay...''} (NH\_F, 2023, E/Implemented, WRS = 0,000) đạt rủi ro thấp nhờ ba yếu tố đồng thời: nhãn Implemented, bằng chứng KPI cụ thể (support = 1), và NLI xác nhận \textit{entailment}.
...
\textit{TBố:} ``Nghiên cứu, triển khai áp dụng các tiêu chuẩn môi trường - xã hội - quản trị trong doanh nghiệp (ESG).'' \newline \textit{BC:} Có (không xác nhận)
    & G / Indeterminate & --- & neutral & 0 & 0,550 \\
\midrule
...
\textit{TBố:} ``Hoàn thành nhiều cấu phần dự án Basel II quan trọng, tiếp tục triển khai tích hợp các mô hình xếp hạng tín dụng nội bộ...'' \newline \textit{BC:} ``Tăng cường quản trị rủi ro thông qua hoàn thành các dự án trọng điểm về Basel II...''
    & G / Implemented & Standard & entail. & 1 & 0,000 \\
\midrule
